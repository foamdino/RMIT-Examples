...
public class Inventory {
    ...
    public synchronized void replenish(String threadName, int productType, int quantity) {
    ...
    public synchronized void withdraw(String threadName, int productType, int quantity) {
